...
public class BranchController {
	...
	@Transactional
	@RequestMapping(value = "/api/branches/", method = RequestMethod.PUT, consumes="application/json")
	...
	@RequestMapping(value = "/api/branches/", method = RequestMethod.DELETE, consumes="application/json")
	public void deleteBranch(@RequestBody Branch branch) throws SQLException{
		brdao.deleteBranch(branch);
	}
	
	@RequestMapping(value = "/api/branches/count", method = RequestMethod.GET, produces="application/json")
	public Integer getBranchesCount() throws SQLException {
		return brdao.getBranchesCount();
	}
	
	@RequestMapping(value = "/api/branches/{pageNo}/{searchString}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/api/branches/{branchId}", method = RequestMethod.GET, produces="application/json")
	public Branch getBranchById(@PathVariable Integer branchId) throws SQLException{
		return brdao.getBranchByPK(branchId);
	}
	
	@RequestMapping(value = "/api/branches/books/", method = RequestMethod.PUT, consumes="application/json")
	...
	@RequestMapping(value = "/api/branches/bookCopies/", method = RequestMethod.PUT, consumes="application/json")
	public void updateBookCopies(@RequestBody BookCopies bc) throws SQLException {
		bcdao.updateBookCopies(bc);
	}
	
	@RequestMapping(value = "/api/branches/{branchId}/books/", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/api/branches/{branchId}/bookCopies/", method = RequestMethod.GET, produces="application/json")
	public List<BookCopies> getBookCopiesInBranch(@PathVariable Integer branchId)
			throws SQLException {
		return bcdao.getBookCopiesByBranchId(branchId);
	}
	
	@RequestMapping(value = "/api/branches/{branchId}/bookCopies/{bookId}", method = RequestMethod.GET, produces="application/json")
